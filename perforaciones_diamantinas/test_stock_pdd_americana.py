"""
Prueba detallada del Stock de Productos Diamantados (PDD) para AMERICANA
Centro de Costo: 000002
"""
import os
import sys
import django
...
# Obtener contrato AMERICANA directamente
from drilling.models import Contrato
contrato_obj = Contrato.objects.get(nombre_contrato='AMERICANA')
centro_costo = contrato_obj.codigo_centro_costo

print("=" * 80)
print("ANÁLISIS DE STOCK - PRODUCTOS DIAMANTADOS (PDD)")
print("CONTRATO: AMERICANA")
print("CENTRO DE COSTO: 000002")
print("=" * 80)
