...
class AsistenciaTrabajador(models.Model):
    ...
    ESTADO_ASISTENCIA_CHOICES = [
        ...
        ("TD", "TRABAJADO DIA"),
        ("TN", "TRABAJADO NOCHE"),
        ("TI", "TRABAJADO + INCENTIVO POR SUPERAR METROS"),
        ("DL", "DIA LIBRE"),
        ("DA", "DIA APOYO"),
        ...
        ("R", "RECORRIDO"),
        ("F", "FALTA"),
        ("PT1", "PERMISO PATERNIDAD"),
        ("S", "SUSPENSION"),
        ("V", "VACACIONES"),
        ("LSG", "LICENCIA SIN GOCE"),
        ("C", "CESADO"),
        ("TC1", "TRABAJO EN CALIENTE 1HE"),
        ("LFC", "LICENCIA POR FALLECIMIENTO"),
        ("DA1", "DIA DE APOYO CON 1 HORA EXTRA"),
        ("IVN", "INDUCCION VIRTUAL"),
        ("LCG", "LICENCIA CON GOCE"),
        ("LOG", "LICENCIA CON GOCE"),
    ]
...
# =============================================================================
# SECCIÓN: METAS DIARIAS POR MÁQUINA
# =============================================================================

class MetaDiariaMaquina(models.Model):
    """
    Meta diaria de perforación por máquina con fecha de vigencia.

    Implementa un modelo de "tasa efectiva": cada registro define
    cuántos metros/día debe perforar una máquina a partir de una fecha.
    Para cambiar la meta desde un día específico, se agrega un nuevo registro.

    Ejemplo:
    - Máquina A: 15 m/día desde 26/03/2026
    - Máquina A: 20 m/día desde 05/04/2026  ← nueva meta a partir del día 5
    """
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['maquina', 'fecha_vigencia']),
        ]

    def __str__(self):
        return f"{self.maquina.nombre} — {self.meta_metros_dia} m/día desde {self.fecha_vigencia.strftime('%d/%m/%Y')}"
